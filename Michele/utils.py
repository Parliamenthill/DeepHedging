...
def heston_barrier_value(calculation_date, option_type, barrier_type, barrier, rebate, 
                         v0, kappa, theta, sigma, rho, spot_price, strike_price, maturity_date):
